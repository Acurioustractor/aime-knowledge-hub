...
const getVimeoThumbnail = (url: string) => {
  // For Vimeo, we'll return a placeholder since getting thumbnails requires additional API calls
  return null
}
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🎥 Fetching all videos from Airtable...')

    // Fetch all videos from different sources
